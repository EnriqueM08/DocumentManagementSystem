...
<html>
    ...
    <body>
        <?php
            ...
            echo '<i class="fa fa-plus-circle fa-5x">';
            echo '</i>';
            echo '<h3>Upload to New Loan</h3>';
            echo '<a href="upload_new.php" class="btn btn-default">Upload New</a>';
            echo '</div>';
            ...
            echo '<h3>Upload to Existing Loan</h3>';
            echo '<a href="upload_existing.php" class = "btn btn-default">Upload Existing</a>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
        ?>
